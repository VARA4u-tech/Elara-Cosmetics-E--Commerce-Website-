        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 md:order-1 text-center md:text-left flex flex-col justify-center h-full">
            ...
            <p className="text-muted-foreground text-xs md:text-sm leading-relaxed max-w-lg mx-auto md:mx-0 mb-5 md:mb-6">
              Discover Customised Skincare, an immersive Ayurvedic experience
              tailored to your unique skin concerns. Each creation is blended by
              hand and prepared in harmony with nature, stirred with
              mindfulness, precision and purpose.
            </p>
            <div>
              <Link
                to="/category/face"
