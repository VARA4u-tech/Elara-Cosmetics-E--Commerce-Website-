        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-sm text-primary uppercase tracking-luxury mb-2">
                {product.category}
              </p>
              ...
              {/* Tabs */}
              <div>
                <div className="flex gap-6 mb-4 border-b border-border overflow-x-auto scrollbar-hide">
                  {["description", "ingredients", "how to use", "benefits"].map(
                    (tab) =>
                      (tab !== "benefits" || product.benefits) && (
                        <button
                          ...
                          className={cn(
                            "text-sm uppercase tracking-luxury pb-3 transition-colors whitespace-nowrap",
                            activeTab === tab
