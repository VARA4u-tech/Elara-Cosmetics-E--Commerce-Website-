  ...
  return (
    <div
      className={cn(
        ...
        isExpanded
          ? "bottom-6 right-3 sm:bottom-8 sm:right-8"
          : "bottom-20 right-3 sm:bottom-24 sm:right-3"
      )}
    >
      ...
      <div
        ...
        className={cn(
          ...
          isExpanded
            ...
            : "w-14 h-14 sm:w-16 sm:h-16 opacity-100 scale-100 rounded-full shadow-luxury-lg hover:scale-110"
        )}
      >
